...
#include "frs_interfaces/msg/detail/detectie_resultaat__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // klasse
#include "rosidl_runtime_c/string_functions.h"  // klasse

// forward declare type support functions


using _DetectieResultaat__ros_msg_type = frs_interfaces__msg__DetectieResultaat;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: klasse
  {
    const rosidl_runtime_c__String * str = &ros_message->klasse;
  ...
  frs_interfaces__msg__DetectieResultaat * ros_message)
{
  // Field name: klasse
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->klasse.data) {
      rosidl_runtime_c__String__init(&ros_message->klasse);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->klasse,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'klasse'\n");
      return false;
    }
  }
...
{
  const _DetectieResultaat__ros_msg_type * ros_message = static_cast<const _DetectieResultaat__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = frs_interfaces__msg__DetectieResultaat;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const frs_interfaces__msg__DetectieResultaat * ros_message = static_cast<const frs_interfaces__msg__DetectieResultaat *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_frs_interfaces__msg__DetectieResultaat(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  frs_interfaces__msg__DetectieResultaat * ros_message = static_cast<frs_interfaces__msg__DetectieResultaat *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_frs_interfaces__msg__DetectieResultaat(cdr, ros_message);
}

static uint32_t _DetectieResultaat__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_frs_interfaces__msg__DetectieResultaat(
...
static size_t _DetectieResultaat__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_frs_interfaces__msg__DetectieResultaat(
...
static message_type_support_callbacks_t __callbacks_DetectieResultaat = {
  "frs_interfaces::msg",
  "DetectieResultaat",
...
static rosidl_message_type_support_t _DetectieResultaat__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_DetectieResultaat,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, frs_interfaces, msg, DetectieResultaat)() {
  return &_DetectieResultaat__type_support;
}
