...
static const _DetectieResultaat_type_support_symbol_names_t _DetectieResultaat_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, frs_interfaces, msg, DetectieResultaat)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, frs_interfaces, msg, DetectieResultaat)),
  }
};
...
{
  return &::frs_interfaces::msg::rosidl_typesupport_cpp::DetectieResultaat_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, frs_interfaces, msg, DetectieResultaat)() {
  return get_message_type_support_handle<frs_interfaces::msg::DetectieResultaat>();
}
